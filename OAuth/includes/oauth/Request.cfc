component accessors="true" {
	...
	property type="includes.oauth.Consumer" name="consumer";
	property type="string" name="method";
	property type="string" name="nonce";
	property type="includes.oauth.Token" name="token";
	...
	*/
	public string function getSerializedParameters() {
		var stringUtil = new includes.utils.StringUtil();
	...
	*/
	public void function signWithSignatureMethod(required includes.oauth.methods.SignatureMethod signatureMethod) {
	...
	*/
	public void function setMethod(required string method) {
		...
		if (not ReFindNoCase("(get|post)", arguments.method)) {
			var exception = new includes.exceptions.InvalidArgumentTypeException();
